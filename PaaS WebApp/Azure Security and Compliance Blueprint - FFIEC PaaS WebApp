...
This Azure Security and Compliance Blueprint provides guidance for the deployment of a Federal Financial Institution Examination Council (FFIEC) Financial Services Regulated Workloads compliant platform as a service (PaaS) environment suitable for the collection, storage, and retrieval of financial data. It showcases a common reference architecture and demonstrates the proper handling of financial data in a secure, compliant, multi-tier environment. This blueprint illustrates an end-to-end solution to meet the needs of organizations seeking a cloud-based approach to reducing the burden and cost of deployment.
...
Furthermore, Application Insights provides real time application performance management and analytics through Operations Management Suite. **Microsoft recommends configuring a VPN or ExpressRoute connection for management and data import into the reference architecture subnet.**

![Reference Architecture](Azure%20Security%20and%20Compliance%20Blueprint%20-%20FFIEC%20NHS%20PaaS%20WebApp%20Reference%20Architecture.png)
...
![Threat Model](Azure%20Security%20and%20Compliance%20Blueprint%20-%20FFIEC%20NHS%20PaaS%20WebApp%20Threat%20Model.png)
