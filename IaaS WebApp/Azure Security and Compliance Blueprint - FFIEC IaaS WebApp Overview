...
This Azure Security and Compliance Blueprint provides guidance for the deployment of a Federal Financial Institution Examination Council (FFIEC) Financial Services Regulated Workload compliant infrastructure as a service (IaaS) environment suitable for the collection, storage, and retrieval of financial data. It showcases a common reference architecture and demonstrates the proper handling of financial data in a secure, compliant, multi-tier environment. This blueprint illustrates an end-to-end solution to meet the needs of organizations seeking a cloud-based approach to reducing the burden and cost of deployment.
...
![Reference Architecture](Azure%20Security%20and%20Compliance%20Blueprint%20-%20FFIEC%20NHS%20IaaS%20WebApp%20Reference%20Architect.png)
...
![Threat Model](Azure%20Security%20and%20Compliance%20Blueprint%20-%20FFIEC%20NHS%20IaaS%20WebApp%20Threat%20Model.png)
